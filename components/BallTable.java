...
public class BallTable {
    ...
    public BallTable(Rules rules){
        ...
        balls.add(new Ball(BALLS_INIT_POS_X[2],BALLS_INIT_POS_Y[2], 0, 0, BallTypeEnum.PLAIN, 2));
        balls.add(new Ball(BALLS_INIT_POS_X[3],BALLS_INIT_POS_Y[3], 0, 0, BallTypeEnum.PLAIN, 3));
        balls.add(new Ball(BALLS_INIT_POS_X[4],BALLS_INIT_POS_Y[4], 0, 0, BallTypeEnum.PLAIN, 4));
        balls.add(new Ball(BALLS_INIT_POS_X[5],BALLS_INIT_POS_Y[5], 0, 0, BallTypeEnum.PLAIN, 5));
        balls.add(new Ball(BALLS_INIT_POS_X[6],BALLS_INIT_POS_Y[6], 0, 0, BallTypeEnum.PLAIN, 6));
        balls.add(new Ball(BALLS_INIT_POS_X[7],BALLS_INIT_POS_Y[7], 0, 0, BallTypeEnum.PLAIN, 7));
        balls.add(new Ball(BALLS_INIT_POS_X[8],BALLS_INIT_POS_Y[8], 0, 0, BallTypeEnum.BLACK, 8));
        balls.add(new Ball(BALLS_INIT_POS_X[9],BALLS_INIT_POS_Y[9], 0, 0, BallTypeEnum.STRIPED, 9));
        balls.add(new Ball(BALLS_INIT_POS_X[10],BALLS_INIT_POS_Y[10], 0, 0, BallTypeEnum.STRIPED, 10));
        balls.add(new Ball(BALLS_INIT_POS_X[11],BALLS_INIT_POS_Y[11], 0, 0, BallTypeEnum.STRIPED, 11));
        balls.add(new Ball(BALLS_INIT_POS_X[12],BALLS_INIT_POS_Y[12], 0, 0, BallTypeEnum.STRIPED, 12));
        balls.add(new Ball(BALLS_INIT_POS_X[13],BALLS_INIT_POS_Y[13], 0, 0, BallTypeEnum.STRIPED, 13));
        balls.add(new Ball(BALLS_INIT_POS_X[14],BALLS_INIT_POS_Y[14], 0, 0, BallTypeEnum.STRIPED, 14));
        balls.add(new Ball(BALLS_INIT_POS_X[15],BALLS_INIT_POS_Y[15], 0, 0, BallTypeEnum.STRIPED, 15));
